...
module unsaved_mm_interconnect_0 (
	...
	wire  [86:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_gen2_0_instruction_master_agent:rp_data
	wire         rsp_mux_src_ready;                                                                  // nios2_gen2_0_instruction_master_agent:rp_ready -> rsp_mux:src_ready
	wire   [1:0] rsp_mux_src_channel;                                                                // rsp_mux:src_channel -> nios2_gen2_0_instruction_master_agent:rp_channel
	...
	wire  [86:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [86:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [86:0] nios2_gen2_0_instruction_master_agent_cp_data;                                      // nios2_gen2_0_instruction_master_agent:cp_data -> router:sink_data
	...
	wire  [86:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_001:sink_data
